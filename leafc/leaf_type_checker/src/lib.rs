use leaf_coreapi::diagnose::{CompileTimeErrorKind, DiagCtx, ErrorKind, LocalizedMessage, MsgKind, TypeCheckerErrorKind};
use leaf_coreapi::hir::{HirBinOp, HirCatchParam, HirCrate, HirCtorDef, HirDeclId, HirDeclKind, HirExprId, HirExprKind, HirFieldDef, HirGenericParam, HirLit, HirName, HirParam, HirPattern, HirTypeName, HirUnaryOp};
use leaf_coreapi::lang_items::BuiltinType;
use leaf_coreapi::name_pass::NamePassResult;
use leaf_coreapi::scope::SymId;
use leaf_coreapi::source::Span;
use leaf_coreapi::type_checker::TypeCheckerApi;
...
impl<'a> TypeChecker<'a> {
    ...
    self.diag.emit_error(
        ...
        self.hir_crate.hir_decl_pool[decl_id].span.clone(),
...
impl<'a> TypeCheckerApi<'a> for TypeChecker<'a> {
    fn new(mut hir_crate: HirCrate, diag: &'a mut DiagCtx) -> Self {
    ...
    fn check(mut self) -> Result<(TypeCtx, HirCrate), ()> {
