...
use leaf_coreapi::diagnose::{
    CompileTimeErrorKind, DiagError, ErrorKind, TokenPassErrorKind, make_error,
};
use leaf_coreapi::token::TokenStream;
use leaf_coreapi::token::TokenType::{Comma, Ident, Lparen, Rparen};
use leaf_coreapi::source::{SourceId, Span};
use leaf_coreapi::pass::PreprocessorApi;
...
impl<'a> PreprocessorApi<'a> for Preprocessor<'a> {
    ...
    fn pass(&mut self) -> Result<TokenStream, DiagError> {
