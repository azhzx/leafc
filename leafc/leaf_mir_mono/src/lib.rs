use leaf_coreapi::diagnose::{CompileTimeErrorKind, DiagCtx, ErrorKind, LocalizedMessage, MirMonoErrorKind, MsgKind};
use leaf_coreapi::hir::HirDeclId;
use leaf_coreapi::lang_items::BuiltinType;
use leaf_coreapi::mir::*;
use leaf_coreapi::mir_mono::MirMonoApi;
...
impl<'a> MirMonoApi<'a> for MirMono<'a> {
    fn new(mir: MirCrate, type_checker_result: TypeCtx, diag: &'a mut DiagCtx) -> Self {
        Self { diag, mir, type_checker_result }
    }

    fn mono(mut self) -> Result<(MirCrate, TypeCtx), ()> {
